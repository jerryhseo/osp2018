...
/**
 * The base model interface for the Lab service. Represents a row in the &quot;meridian_Lab&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.kisti.osp.meridian.model.impl.LabModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.kisti.osp.meridian.model.impl.LabImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface LabModel extends BaseModel<Lab>, GroupedModel, ShardedModel,
	StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a lab model instance should use the {@link Lab} interface instead.
	 */
