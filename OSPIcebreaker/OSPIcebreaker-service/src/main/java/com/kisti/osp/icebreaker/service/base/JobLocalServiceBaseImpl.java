...
import com.kisti.osp.icebreaker.service.JobLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.kisti.osp.icebreaker.service.impl.JobLocalServiceImpl}.
 * </p>
 *
 * @author Jerry H. Seo
...
public abstract class JobLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements JobLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.kisti.osp.icebreaker.service.JobLocalServiceUtil} to access the job local service.
	 */
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Job>() {
				@Override
	...
	public List<Job> getJobsByUuidAndCompanyId(String uuid, long companyId,
		...
		return jobPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	public JobLocalService getJobLocalService() {
	 ...
	 */
	public void setJobLocalService(JobLocalService jobLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.kisti.osp.icebreaker.model.Job",
			jobLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.kisti.osp.icebreaker.model.Job");
	}
	...
	@BeanReference(type = JobLocalService.class)
