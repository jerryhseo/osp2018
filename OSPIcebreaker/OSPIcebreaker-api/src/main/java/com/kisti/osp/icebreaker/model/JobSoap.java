...
/**
 * This class is used by SOAP remote services, specifically {@link com.kisti.osp.icebreaker.service.http.JobServiceSoap}.
 *
 * @author Jerry H. Seo
 * @see com.kisti.osp.icebreaker.service.http.JobServiceSoap
 * @generated
 */
@ProviderType
public class JobSoap implements Serializable {
	public static JobSoap toSoapModel(Job model) {
		...
		soapModel.setReserveResults(model.getReserveResults());
