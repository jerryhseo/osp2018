 ...
 * @generated
 */
@ImplementationClassName("com.kisti.osp.icebreaker.model.impl.JobImpl")
@ProviderType
public interface Job extends JobModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.kisti.osp.icebreaker.model.impl.JobImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Job, String> UUID_ACCESSOR = new Accessor<Job, String>() {
			@Override
	...
	public static final Accessor<Job, Long> JOB_ID_ACCESSOR = new Accessor<Job, Long>() {
			@Override
