...
public class OSPSchedulerAssetRendererFactory extends BaseAssetRendererFactory<OSPSchedulerEntry> {
	...
	public OSPSchedulerAssetRendererFactory() {
		...
		super.setPortletId(OSPIcebreakerWebPortletKeys.OSPSchedulerManager);
	...
	public PortletURL getURLAdd(
	    ...
	    PortletURL portletURL = PortalUtil.getControlPanelPortletURL(
	        ...
	        OSPIcebreakerWebPortletKeys.OSPSchedulerManager,
	...
	public PortletURL getURLView(
	    ...
	    LiferayPortletURL liferayPortletURL =
	        liferayPortletResponse.createLiferayPortletURL(
	        		OSPIcebreakerWebPortletKeys.OSPSchedulerManager, PortletRequest.RENDER_PHASE);
