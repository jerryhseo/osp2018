...
@Component(
	...
	property = {
        ...
        "mvc.command.name=/SchedulerManager/view"
    },
    service = MVCRenderCommand.class
)
public class ViewOSPSchedulerRenderCommand implements MVCRenderCommand {
	
	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		_log.info("Rendering view.jsp");
	
		RequestDispatcher requestDispatcher =
            this.servletContext.getRequestDispatcher("/SchedulerManager/view.jsp");
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ViewOSPSchedulerRenderCommand.class);
}