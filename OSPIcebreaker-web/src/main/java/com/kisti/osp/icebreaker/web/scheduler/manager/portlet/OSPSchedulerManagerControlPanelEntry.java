...
public class OSPSchedulerManagerControlPanelEntry extends BasePanelApp {
    ...
    public String getPortletId() {
        return OSPIcebreakerWebPortletKeys.OSPSchedulerManager;    // Same name of the portlet.
    }

    @Override
    @Reference(
        target = "(javax.portlet.name="+OSPIcebreakerWebPortletKeys.OSPSchedulerManager+")",
        unbind = "-"
    )
