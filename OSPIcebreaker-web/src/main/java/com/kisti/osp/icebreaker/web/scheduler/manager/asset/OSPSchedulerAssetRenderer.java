package com.kisti.osp.icebreaker.web.scheduler.manager.asset;
...
public class OSPSchedulerAssetRenderer extends BaseJSPAssetRenderer<OSPSchedulerEntry> implements TrashRenderer{
	...
	public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
		...
		PortletURL portletURL = PortalUtil.getControlPanelPortletURL(
				liferayPortletRequest, group, OSPIcebreakerWebPortletKeys.OSPSchedulerManager, 0, 0,
	...
	public String getURLView(LiferayPortletResponse liferayPortletResponse, WindowState windowState) throws Exception {
	    ...
	    portletURL.setParameter("mvcRenderCommandName", "/SchedulerManager/full_content");
	    portletURL.setParameter("schedulerId", String.valueOf(this._schedulerEntry.getSchedulerEntryId()));
	...
	public String getURLViewInContext(LiferayPortletRequest liferayPortletRequest,
		...
		return super.getURLViewInContext(
		        liferayPortletRequest, noSuchEntryRedirect, "/SchedulerManager/full_content",
