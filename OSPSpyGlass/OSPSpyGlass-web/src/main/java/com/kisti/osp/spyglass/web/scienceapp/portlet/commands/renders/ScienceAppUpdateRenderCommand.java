...
@Component(
	...
	property = {
        ...
        "mvc.command.name=/scienceApp/asset/update"
    },
    service = MVCRenderCommand.class
)
public class ScienceAppUpdateRenderCommand implements MVCRenderCommand {
	...
	private static final Log _log = LogFactoryUtil.getLog(ScienceAppUpdateRenderCommand.class);
