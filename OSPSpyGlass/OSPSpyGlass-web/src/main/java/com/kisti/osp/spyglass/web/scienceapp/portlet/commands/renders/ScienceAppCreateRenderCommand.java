...
@Component(
	...
	property = {
        ...
        "mvc.command.name=/scienceApp/asset/create"
    },
    service = MVCRenderCommand.class
)
public class ScienceAppCreateRenderCommand implements MVCRenderCommand {
	
	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		System.out.println("ScienceAppCreateRenderCommand");
		...
		return "/scienceApp/asset/create.jsp";
	}

	@Reference(target = "(osgi.web.symbolicname=com.kisti.osp.spyglass.web)")
	protected ServletContext servletContext;

	private static final Log _log = LogFactoryUtil.getLog(ScienceAppCreateRenderCommand.class);
