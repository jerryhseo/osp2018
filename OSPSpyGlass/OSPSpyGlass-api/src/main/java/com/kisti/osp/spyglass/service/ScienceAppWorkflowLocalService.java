...
/**
 * Provides the local service interface for ScienceAppWorkflow. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry H. Seo
 * @see ScienceAppWorkflowLocalServiceUtil
...
public interface ScienceAppWorkflowLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ScienceAppWorkflowLocalServiceUtil} to access the science app workflow local service. Add custom service methods to {@link com.kisti.osp.spyglass.service.impl.ScienceAppWorkflowLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public ScienceAppWorkflow addScienceAppWorkflow(
	...
	*/
	public ScienceAppWorkflow createScienceAppWorkflow(long scienceAppId);
	...
	*/
	...
	public ScienceAppWorkflow deleteScienceAppWorkflow(
		ScienceAppWorkflow scienceAppWorkflow);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ScienceAppWorkflow deleteScienceAppWorkflow(long scienceAppId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ScienceAppWorkflow fetchScienceAppWorkflow(long scienceAppId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ScienceAppWorkflow getScienceAppWorkflow(long scienceAppId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ScienceAppWorkflow updateScienceAppWorkflow(
		ScienceAppWorkflow scienceAppWorkflow);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ScienceAppWorkflow> getScienceAppWorkflows(int start, int end);
