...
public interface ScienceAppOutputPortsPersistence extends BasePersistence<ScienceAppOutputPorts> {
	...
	*/
	public void cacheResult(
		java.util.List<ScienceAppOutputPorts> scienceAppOutputPortses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ScienceAppOutputPorts> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ScienceAppOutputPorts> findAll();
	...
	*/
	public java.util.List<ScienceAppOutputPorts> findAll(int start, int end);
	...
	*/
	public java.util.List<ScienceAppOutputPorts> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ScienceAppOutputPorts> orderByComparator);
