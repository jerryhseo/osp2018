...
<%
	...
	long scienceAppId = ParamUtil.getLong(request, "scienceAppIdId", 0);
	if (scienceAppId > 0) {
		scienceApp = ScienceAppLocalServiceUtil.getScienceApp(scienceAppId);
	}
	
	String backURL = ParamUtil.getString(request, "backURL", "");
	String command = ParamUtil.getString(request, "cmd", "UPDATE");
...
<portlet:actionURL name="manageScienceApp" var="manageScienceAppURL">
</portlet:actionURL>

<aui:form action="<%= manageScienceAppURL.toString() %>" name="<portlet:namespace />fm">
	<aui:fieldset>
