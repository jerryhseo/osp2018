...
public class ScienceAppManagerCacheModel implements CacheModel<ScienceAppManager>,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ScienceAppManagerCacheModel)) {
			return false;
		}

		ScienceAppManagerCacheModel scienceAppManagerCacheModel = (ScienceAppManagerCacheModel)obj;

		if (scienceAppManagerId == scienceAppManagerCacheModel.scienceAppManagerId) {
			return true;
		}
	...
	@Override
	public int hashCode() {
		return HashUtil.hash(0, scienceAppManagerId);
	}
