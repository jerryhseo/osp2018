 ...
 * @generated
 */
@ImplementationClassName("OSPIcecap.model.impl.DataTypeImpl")
@ProviderType
public interface DataType extends DataTypeModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link OSPIcecap.model.impl.DataTypeImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public static final Accessor<DataType, Long> TYPE_ID_ACCESSOR = new Accessor<DataType, Long>() {
			@Override
