...
/**
 * Provides the local service interface for DataTypeAnalyzerLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Jerry H. Seo
 * @see DataTypeAnalyzerLinkLocalServiceUtil
...
public interface DataTypeAnalyzerLinkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DataTypeAnalyzerLinkLocalServiceUtil} to access the data type analyzer link local service. Add custom service methods to {@link OSPIcecap.service.impl.DataTypeAnalyzerLinkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public DataTypeAnalyzerLink addDataTypeAnalyzerLink(
	...
	*/
	public DataTypeAnalyzerLink createDataTypeAnalyzerLink(
	...
	*/
	...
	public DataTypeAnalyzerLink deleteDataTypeAnalyzerLink(
		DataTypeAnalyzerLink dataTypeAnalyzerLink);
	...
	*/
	...
	public DataTypeAnalyzerLink fetchDataTypeAnalyzerLink(
		DataTypeAnalyzerLinkPK dataTypeAnalyzerLinkPK);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DataTypeAnalyzerLink getDataTypeAnalyzerLink(
		DataTypeAnalyzerLinkPK dataTypeAnalyzerLinkPK)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public DataTypeAnalyzerLink updateDataTypeAnalyzerLink(
		DataTypeAnalyzerLink dataTypeAnalyzerLink);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DataTypeAnalyzerLink> getDataTypeAnalyzerLinks(int start,
		int end);
