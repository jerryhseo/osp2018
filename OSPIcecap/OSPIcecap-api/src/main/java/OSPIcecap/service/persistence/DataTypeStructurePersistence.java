...
public interface DataTypeStructurePersistence extends BasePersistence<DataTypeStructure> {
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DataTypeStructure> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<DataTypeStructure> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DataTypeStructure> orderByComparator);
