...
import OSPIcecap.model.DataCollectionModel;
import OSPIcecap.model.DataCollectionSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link DataCollectionModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link DataCollectionImpl}.
 * </p>
 *
 * @author Jerry H. Seo
...
public class DataCollectionModelImpl extends BaseModelImpl<DataCollection>
	...
	public static final String TABLE_SQL_CREATE = "create table icecap_DataCollection (uuid_ VARCHAR(75) null,name VARCHAR(75) null,version VARCHAR(75) null,title STRING null,groupId LONG,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,description LONG,status INTEGER,accessMethod VARCHAR(75) null,collectionId LONG not null primary key,typeId LONG)";
	public static final String TABLE_SQL_DROP = "drop table icecap_DataCollection";
	public static final String ORDER_BY_JPQL = " ORDER BY dataCollection.createDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY icecap_DataCollection.createDate DESC";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(OSPIcecap.service.util.ServiceProps.get(
				"lock.expiration.time.OSPIcecap.model.DataCollection"));
	...
	public void prepareLocalizedFieldsForImport() throws LocaleException {
		...
		Locale defaultImportLocale = LocalizationUtil.getDefaultImportLocale(DataCollection.class.getName(),
	...
	public String toXmlString() {
		...
		sb.append("OSPIcecap.model.DataCollection");
	...
	private static final ClassLoader _classLoader = DataCollection.class.getClassLoader();
