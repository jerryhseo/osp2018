...
import OSPIcecap.service.DataTypeStructureService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link OSPIcecap.service.impl.DataTypeStructureServiceImpl}.
 * </p>
 *
 * @author Jerry H. Seo
...
public abstract class DataTypeStructureServiceBaseImpl extends BaseServiceImpl
	implements DataTypeStructureService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link OSPIcecap.service.DataTypeStructureServiceUtil} to access the data type structure remote service.
	 */
	 ...
	 */
	public DataTypeStructureService getDataTypeStructureService() {
	...
	@BeanReference(type = DataTypeStructureService.class)
