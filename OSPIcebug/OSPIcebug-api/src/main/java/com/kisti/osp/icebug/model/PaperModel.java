...
/**
 * The base model interface for the Paper service. Represents a row in the &quot;icebug_Paper&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.kisti.osp.icebug.model.impl.PaperModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.kisti.osp.icebug.model.impl.PaperImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface PaperModel extends BaseModel<Paper>, GroupedModel, ShardedModel,
	StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a paper model instance should use the {@link Paper} interface instead.
	 */
