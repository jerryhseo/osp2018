...
<%@page import="com.kisti.osp.icebreaker.scheduler.manager.configuration.OSPSchedulerManagerPortletConfiguration"%>
...
<portlet:renderURL var="addURL">
	<portlet:param name="mvcRenderCommandName" value="/html/edit_scheduler" />
...
<liferay-ui:search-container 
	...
	<liferay-ui:search-container-row className="com.kisti.osp.icebreaker.model.OSPSchedulerEntry" modelVar="scheduler" keyProperty="schedulerEntryId" >
		...
		<portlet:renderURL var="rowURL">
			...
			<portlet:param name="mvcRenderCommandName" value="/html/full_content"/>
		</portlet:renderURL>
