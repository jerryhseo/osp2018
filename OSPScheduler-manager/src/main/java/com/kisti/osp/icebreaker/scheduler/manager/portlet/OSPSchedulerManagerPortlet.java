...
import com.kisti.osp.icebreaker.scheduler.manager.configuration.OSPSchedulerManagerPortletConfiguration;
 ...
 */
@Component(
		configurationPid = "com.kisti.osp.icebreaker.scheduler.manager.portlet.OSPSchedulerManagerConfiguration",
		immediate = true,
		property = {
