package com.kisti.osp.icebreaker.scheduler.manager.adt;
...
public class OSPSchedulerManagerDisplayTemplateHandler extends BasePortletDisplayTemplateHandler {
	...
	public String getName(Locale locale) {
		...
		String portletTitle = _portal.getPortletTitle(
					OSPSchedulerManagerPortletKeys.OSPSchedulerManager, resourceBundle);
	...
	public String getResourceName() {
		...
		return OSPSchedulerManagerPortletKeys.OSPSchedulerManager;
	}
	...
	protected String getTemplatesConfigPath() {
		return "com/kisti/osp/icebreaker/scheduler/template/dependencies/portlet-display-templates.xml";
	}
